  ...
  return(
    <div>
      <nav className={`navbar navbar-expand-lg fixed-top ${isCollapsed ? '' : 'show'}`}>
        <div className="container"> {/* Use .container instead of .container-fluid */}
          <div className="d-flex align-items-center"> {/* Flex container for brand */}
            <a className="navbar-brand" href="https://www.linkedin.com/in/kuruva-pavani-10388b27b" target='_blank'>KURUVA PAVANI</a>
          </div>
